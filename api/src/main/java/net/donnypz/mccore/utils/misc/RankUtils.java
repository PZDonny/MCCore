...
public class RankUtils {
    ...
    public static String getPlayerGroupName(@NotNull Player p){
        User user = LPAPI.getPlayerAdapter(Player.class).getUser(p);
        return user.getPrimaryGroup();
    }

    public static String getPlayerPrefixString(@NotNull Player p){
        if (p.isOnline()){
            User user = LPAPI.getPlayerAdapter(Player.class).getUser(p);
    ...
    public static Component getPlayerPrefix(@NotNull Player p){
        if (p.isOnline()){
            User user = LPAPI.getPlayerAdapter(Player.class).getUser(p);
    ...
    public static String getOfflinePlayerPrefixString(@NotNull UUID uuid){
    ...
    public static Component getOfflinePlayerPrefix(@NotNull UUID uuid){
        Player p = Bukkit.getPlayer(uuid);
        if (p != null && p.isOnline()){
    ...
    private static Component getPrefixComponent(@NotNull String prefixString){
        if (prefixString == null){
    ...
    public static ChatColor getPlayerChatColor(@NotNull Player p){
    //Online Player
    ...
    public static NamedTextColor getPlayerNamedTextColor(@NotNull Player p){
    //Online Player
        if (p.hasPermission("mc.ranked")){
    ...
    public static int getGroupWeight(@NotNull String groupName){
    ...
    public static String getGroupPrefix(@NotNull Group group){
