...
public class ProjectileRandomnessListener implements Listener {


    @EventHandler (priority = EventPriority.HIGHEST)
    public void onProjectileLaunch(ProjectileLaunchEvent e) {
        if (!CoreAPI.getConfigOptions().projectileRandomness){
            return;
        }
        ...
        * Multishot crossbows shoot arrows w/o the effects of player velocity, but with nearly the same speed and direction as newer versions
        * */
