...
//Prevent Item Drops
    ...
    //Arena Related
        ...
        if (arena != null){
            ...
            if (CoreAPI.getConfigOptions().waitingWorldLimited && p.getWorld().equals(CoreAPI.getConfigOptions().waitingWorld)){
                e.setCancelled(true);
            }
        }
    }
...
//World Changes (Arena Removal)
    ...
    public void onWorldChange(PlayerChangedWorldEvent e){
        ...
        if (arena.getArenaPlayers().contains(p)){
            ...
            if (p.getWorld() == CoreAPI.getConfigOptions().waitingWorld && CoreAPI.getConfigOptions().waitingWorldLimited){
            ...
            else if (!CoreAPI.getConfigOptions().waitingWorldLimited){
...
//Player Dismount BlockDisplay (Arena Waiting World)
    ...
    public void onSneak(PlayerToggleSneakEvent e){
        if (!CoreAPI.getConfigOptions().isMinigameEnabled || !CoreAPI.getConfigOptions().waitingWorldLimited){
            return;
        }
        ...
        if (!p.getWorld().equals(CoreAPI.getConfigOptions().waitingWorld)){
            return;
        }
