...
public class GamemodeCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (!sender.hasPermission("mc.gamemode")) { //Player w/o perms
        ...
        if (args.length > 0) {
            ...
            if (p == null) {
                ...
                return true;
            } else if (p.hasPermission("mc.gamemode.admin")){
                self = false;
            }
            else{
                p.sendMessage(ChatColor.RED+"You do not have permission to change another player's gamemode!");
                return true;
            }
